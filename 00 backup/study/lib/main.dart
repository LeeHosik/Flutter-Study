...
import 'package:study/07_pages/b7day6_PickerView_exercise.dart';
import 'package:study/07_pages/b7day6_PickerView_exercise_2.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/b7day6_PickerView_exercise': (context) =>
            const b7day6_PickerView_exercise(),
        '/b7day6_PickerView_exercise_2': (context) =>
            const b7day6_PickerView_exercise_2(),
