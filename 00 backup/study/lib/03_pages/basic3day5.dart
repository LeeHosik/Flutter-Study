...
class basic3Day4CalcFinal extends StatefulWidget {
  const basic3Day4CalcFinal({super.key});

  @override
  State<basic3Day4CalcFinal> createState() => _HomeState();
}

class _HomeState extends State<basic3Day4CalcFinal> {
