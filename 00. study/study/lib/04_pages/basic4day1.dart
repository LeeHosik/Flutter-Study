...
class Basic4day1_SwitchCalc extends StatefulWidget {
  const Basic4day1_SwitchCalc({super.key});

  @override
  State<Basic4day1_SwitchCalc> createState() => _HomeState();
}

class _HomeState extends State<Basic4day1_SwitchCalc> {
